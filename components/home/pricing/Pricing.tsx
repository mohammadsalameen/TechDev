...
const Pricing = () => {
  return (
    <div className='pt-16 pb-16 bg-gray-100'>
       ...
       <div data-aos = 'fade-right' data-aos-delay = '100' data-aos-anchor-placement = 'top-center' className='w-[80%] mx-auto mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 items-center'>
        {
